...
public class DiseaseSymptoms2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dsTVlarge.setText( getIntent().getStringExtra("Dname"));
        ...
        dsbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_to_Hospitals = new Intent(DiseaseSymptoms2.this , Hospitalss2.class);
